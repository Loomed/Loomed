                ...
                <div class="card">
                    ...
                    <div class="tab-content">
                        <h4>
                            ...
                            <div class="col-xs-9"><label>全体管理</label></div>
                        </h4>
                        <h5> <div class="col-xs-9"><label>権限：ルート</label></div></h5>
                        <p>
                            <button class="btn btn-primary btn-block" onclick="location.href='userinfo.jsp';">ユーザ情報</button>
                        </p>
                        <p>
                            <button class="btn btn-primary btn-block" onclick="location.href='userconfig.jsp';">ユーザ管理</button>
                        </p>
                        <p>
                            <button class="btn btn-primary btn-block" onclick="location.href='trainingconfig.jsp';">研修管理</button>
                        </p>
                        <p>
